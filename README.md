# <img src="src/main/resources/assets/icon.ico" width="35" /> DroneFront - Tower Defense
...
## <img src="src/main/resources/assets/enemies/scout_normal.png" width="35" /> Sobre o Projeto
...
## <img src="src/main/resources/assets/enemies/bomber_normal.png" width="35" /> Requisitos
...
## <img src="src/main/resources/assets/enemies/tank_normal.png" width="35" /> Baixar e Jogar
...
## <img src="src/main/resources/assets/hud/tablet.png" width="20" /> Controles e Jogabilidade
...
## <img src="src/main/resources/assets/towers/fire_3.png" width="35" /> Arsenal e Inimigos
...
## <img src="src/main/resources/assets/map/tile_foundation.png" width="35" /> Histórico de Atualizações

`20/09`: Atualmente os inimigos apenas percorrem o caminho e causam dano, o jogo termina ao zerar vida. (Entrega 1)  
`28/10`: Lógica de adição/remoção de torres, dano com projéteis e economia inicial. (Entrega 2)  
`15/11`: Novos inimigos, torres, sistema de upgrades, mecânicas de vulnerabilidade e spawn probabilístico. (Entrega 3)  
`29/11`: Melhorias finais de polimento e balanceamento. (Entrega Final)

> As justificativas de design e diagramas de cada entrega estão em `docs/`
